...
void render::dump_buffer(
    render::RenderBuffer& buf, 
    const std::string& scene_dir, 
    const std::string& prefix, 
    const std::string& fname){
    // color
    std::string color_dir = scene_dir+"/"+prefix+"_color";
    ...
    // depth    
    std::string depth_dir = scene_dir+"/"+prefix+"_depth";
    ...
    // normal
    std::string normal_dir = scene_dir+"/"+prefix+"_normal";
    ...
    // pixel coord 
    std::string pixcoord_dir = scene_dir+"/"+prefix+"_pixel_coord";
    ...
    // pixel meta 
    std::string pixmeta_dir = scene_dir+"/"+prefix+"_pixel_meta";
