...
def get_list(scene_dir, label_dir, color_dir, depth_dir, normal_dir, pixcoord_dir, pixmeta_dir, \
             label_ext='png', color_ext='jpg', depth_ext='npz', normal_ext='npz', pixcoord_ext='npz', pixmeta_ext='npz'):
    ...
    assert len(label_imgs) == len(color_imgs) == len(depth_imgs) == len(normal_imgs) \
           == len(pixcoord_imgs) == len(pixmeta_imgs), \
           '[Error] {}, Image length not equal: label {}, color {}, depth {}, normal {}, pixel coordinates {}, pixel meta {}' \
    ...
    return label_imgs, color_imgs, depth_imgs, normal_imgs, pixcoord_imgs, pixmeta_imgs
...
def get_scene_data(labelweights, cam_int_param, get_depth, get_coord, get_pixmeta, point_from_depth, data_dir):
    label_dir, color_dir, depth_dir, normal_dir, pixcoord_dir, pixmeta_dir = data_dir
