...
int main(int argc, char *argv[]) {
    ...
    if(argc<6){
        std::cout << "Usage: ./render dataset_dir pose_mode output_height output_depth num_thread"<<std::endl;
        ...
        std::cout << "[INFO]: ./render dataset_dir pose_mode output_height output_depth num_thread"<<std::endl;
        std::cout << "\tdataset_dir: "<<argv[1]<<std::endl;
        std::cout << "\tpose_mode: "<<argv[2]<<std::endl;
        std::cout << "\toutput_height: "<<argv[3]<<std::endl;
        std::cout << "\toutput_width:"<<argv[4]<<std::endl;
        std::cout << "\tnum_thread:"<<argv[5]<<std::endl;
    }
    ...
    for(unsigned int sid=0; sid<scene_dirs.size(); sid++){
        ...
        //std::cout<<cam_extrinsic<<std::endl;

        /** get all poses **/
        int pose_mode = atoi(argv[2]);
        ...
        unsigned int num_workers = atoi(argv[5]);
        // parameters
        ...
        ts = omp_get_wtime() - ts;
        std::cout << "\tprocessing time: "<< ts <<" sec"<< std::endl;
    }
    std::cout << "\n------------------------ Finish ----------------------------" << std::endl;
