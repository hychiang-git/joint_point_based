...
def render(scene_dir):
    ...
    scene_pixel_coord = os.path.join(DATA_DIR, scene_dir, "pixel_coord")
    ...
    scene_pixel_meta = os.path.join(DATA_DIR, scene_dir, "pixel_meta")
    ...
    scene_render_label = os.path.join(DATA_DIR, scene_dir, "render_label")
