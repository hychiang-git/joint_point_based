...
void render(vector<Point3> &v, vector<int3> &f, vector<uchar4> &v_color, Matrix4f intrinsic, Matrix4f extrinsic, const string& output_fname){
...
int main(int argc, char *argv[]) {
    ...
    for(int i =0; i<posefiles.size(); i++){
        ...
        render(vertex, face, vertex_color, cam_intrinsic, extrinsic, output_fname);
    }
    return 0;
}
